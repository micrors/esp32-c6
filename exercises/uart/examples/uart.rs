// View output with `screen /dev/ttyACM0 <baud>`
// Use "reset" button once after opening `screen`.
#![no_std]
#![no_main]
...
// use defmt::{info, panic/*, debug, error, println, trace, warn*/ };
...
const MAX_LEN: usize = 102; // 100 text-bytes plus \r\n
const CR: u8 = 0x0D; // Carriage Return hex code.
const LF: u8 = 0x0A; // Line Feed hex code.

#[main]
fn main() -> ! {
    // Initialise MCU modules (peripherals.)
